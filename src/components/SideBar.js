...
const SidebarWrapper = () => {
  ...
  return (
    <Container bg={backgroundColor} h="100vh" p="0" m="0">
      <Box textColor="white" mb="2" p="4">
        <Text
          align="center"
          fontSize="23px"
          fontWeight="600"
      ...
      <VStack display="block" pt="5" spacing="30px">
        ...
        <HStack
          ...
          textColor="white"
          borderLeft={pathname === "/dashboard/accounts" ? "2px solid white" : "none"}
        >
        ...
        <HStack
          ...
          textColor="white"
          borderLeft={pathname === "/dashboard/transactions" ? "2px solid white" : "none"}
        >
        ...
        <HStack
          onClick={() => nav("/dashboard/statistics")}
          textColor="white"
          borderLeft={pathname === "/dashboard/statistics" ? "2px solid white" : "none"}
        >
        ...
        <HStack
          ...
          textColor="white"
          borderLeft={pathname === "/dashboard/billPayments" ? "2px solid white" : "none"}
        >
